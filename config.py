...
PIECE_SPAWN_HEIGHT_OFFSET = -3
PIECE_SPAWN_ROW_LOCATION = HIDDEN_ROWS + PIECE_SPAWN_HEIGHT_OFFSET
PLAY_WIDTH = 300
PLAY_HEIGHT = 600
BLOCK_SIZE = 30
SCREEN_WIDTH = 800
SCREEN_HEIGHT = 750
COLUMNS_ABOVE_GRID = 3
...
BOARD_END_Y_COORDINATE = TOP_LEFT_Y_COORDINATE + PLAY_HEIGHT
...
HOLD_PIECE_SCREEN_LEFT_X_COORDINATE = (
    TOP_LEFT_X_COORDINATE - 10 - HOLD_PIECE_SCREEN_WIDTH
)
HOLD_PIECE_SCREEN_TOP_Y_COORDINATE = TOP_LEFT_Y_COORDINATE

GRAVITY_INCREMENTATION = 0.0035
MILISECONDS_TO_INCREMENT_GRAVITY = 7200
# Controls
DAS_DELAY = 0.1
